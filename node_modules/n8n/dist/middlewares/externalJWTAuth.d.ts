...
export declare const setupExternalJWTAuth: (app: Application, config: import("convict").Config<{
    database: {
        type: string;
        tablePrefix: string;
        logging: {
    ...
    userManagement: {
        ...
        skipInstanceOwnerSetup: boolean;
        emails: {
            mode: string;
            smtp: {
                host: string;
...
}>, authIgnoreRegex: RegExp) => Promise<void>;
