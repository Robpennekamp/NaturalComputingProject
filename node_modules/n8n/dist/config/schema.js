...
exports.schema = {
    ...
    executions: {
        process: {
            ...
            format: ['main', 'own'],
            default: constants_1.IS_V1_RELEASE ? 'main' : 'own',
    ...
    push: {
        backend: {
            ...
            default: constants_1.IS_V1_RELEASE ? 'websocket' : 'sse',
        ...
        config: {
            ...
            sentry: {
                dsn: {
                    ...
                    format: String,
                    default: 'https://1f954e089a054b8e943ae4f4042b2bff@o1420875.ingest.sentry.io/4504016528408576',
                    env: 'N8N_SENTRY_DSN',
                },
            },
            frontend: {
