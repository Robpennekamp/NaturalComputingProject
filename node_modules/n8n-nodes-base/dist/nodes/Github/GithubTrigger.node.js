            ...
            default: {
                ...
                async create() {
                    ...
                    try {
                        ...
                        if (error.cause.httpCode === '404') {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Check that the repository exists and that you have permission to create the webhooks this node requires');
                        }
                        throw error;
                    }
