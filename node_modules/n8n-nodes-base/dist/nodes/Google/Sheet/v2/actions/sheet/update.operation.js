...
async function execute(sheet, sheetName) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        const preparedData = await sheet.prepareDataForUpdateOrUpsert(data, columnToMatchOn, range, headerRow, firstDataRow, valueRenderMode, false, [columnNames.concat([...newColumns])], columnValues);
