        ...
        for (let i = 0; i < length; i++) {
            try {
                if (mode === 'htmlToMarkdown') {
                    ...
                    options.textReplace = !(0, lodash_isempty_1.default)(textReplaceOption)
                    ...
                    options.lineStartEscape = !(0, lodash_isempty_1.default)(lineStartEscapeOption)
                    ...
                    options.globalEscape = !(0, lodash_isempty_1.default)(globalEscapeOption)
                    ...
                    (0, lodash_set_1.default)(newItem, destinationKey, markdownFromHTML);
                ...
                if (mode === 'markdownToHtml') {
                    ...
                    const newItem = (0, n8n_workflow_1.deepCopy)(items[i].json);
                    (0, lodash_set_1.default)(newItem, destinationKey, htmlFromMarkdown);
                    returnData.push(newItem);
                }
            }
            catch (error) {
