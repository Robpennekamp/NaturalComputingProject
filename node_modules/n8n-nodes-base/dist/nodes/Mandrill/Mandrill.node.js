            ...
            try {
                if (resource === 'message') {
                    ...
                    if (jsonActive) {
                        ...
                        if (!(0, lodash_isempty_1.default)(headersUi)) {
                            body.message.headers = (0, lodash_map_1.default)(headersUi.headersValues, (o) => {
                                const aux = {};
                                aux[o.name] = o.value;
                                return aux;
                            });
                        ...
                        if (!(0, lodash_isempty_1.default)(metadataUi)) {
                            body.message.metadata = (0, lodash_map_1.default)(metadataUi.metadataValues, (o) => {
                                const aux = {};
                                aux[o.name] = o.value;
                                return aux;
                            });
                        ...
                        if (!(0, lodash_isempty_1.default)(mergeVarsUi)) {
                            body.message.global_merge_vars = (0, lodash_map_1.default)(mergeVarsUi.mergeVarsValues, (o) => {
                                const aux = {};
                                aux.name = o.name;
                        ...
                        if (!(0, lodash_isempty_1.default)(attachmentsUi)) {
                            if (attachmentsUi.hasOwnProperty('attachmentsValues') &&
                                !(0, lodash_isempty_1.default)(attachmentsUi.attachmentsValues)) {
                                attachmentsValues = (0, lodash_map_1.default)(attachmentsUi.attachmentsValues, (o) => {
                                    const aux = {};
                                    aux.name = o.name;
                                    aux.content = o.content;
                                    aux.type = o.type;
                            ...
                            if (attachmentsUi.hasOwnProperty('attachmentsBinary') &&
                                ...
                                items[i].binary) {
                                attachmentsBinary = (0, lodash_map_1.default)(attachmentsUi.attachmentsBinary, (o) => {
