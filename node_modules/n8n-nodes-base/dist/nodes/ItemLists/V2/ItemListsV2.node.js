...
const lodash_lt_1 = __importDefault(require("lodash.lt"));
...
const compareItems = (obj, obj2, keys, disableDotNotation, _node) => {
    ...
    for (const key of keys) {
        if (!disableDotNotation) {
            if (!(0, lodash_isequal_1.default)((0, lodash_get_1.default)(obj.json, key), (0, lodash_get_1.default)(obj2.json, key))) {
                result = false;
                break;
            }
        }
        else {
            if (!(0, lodash_isequal_1.default)(obj.json[key], obj2.json[key])) {
                result = false;
                break;
            }
        }
...
const flattenKeys = (obj, path = []) => {
    return !(0, lodash_isobject_1.default)(obj)
        ? { [path.join('.')]: obj }
        : (0, lodash_reduce_1.default)(obj, (cum, next, key) => (0, lodash_merge_1.default)(cum, flattenKeys(next, [...path, key])), {});
};
        ...
        if (resource === 'itemList') {
            if (operation === 'splitOutItems') {
                for (let i = 0; i < length; i++) {
                    ...
                    let arrayToSplit;
                    if (!disableDotNotation) {
                        arrayToSplit = (0, lodash_get_1.default)(items[i].json, fieldToSplitOut);
                    }
                    else {
                        ...
                        if (include === 'selectedOtherFields') {
                            ...
                            newItem = {
                                ...fieldsToInclude.reduce((prev, field) => {
                                    ...
                                    let value;
                                    if (!disableDotNotation) {
                                        value = (0, lodash_get_1.default)(items[i].json, field);
                                    }
                                    else {
                            ...
                            (0, lodash_unset_1.default)(newItem, fieldToSplitOut);
                        }
                ...
                if (aggregate === 'aggregateIndividualFields') {
                    ...
                    if (nodeVersion < 2.1) {
                        for (const { fieldToAggregate } of fieldsToAggregate) {
                            ...
                            for (const item of items) {
                                ...
                                if (!disableDotNotation) {
                                    if ((0, lodash_get_1.default)(item.json, fieldToAggregate) !== undefined) {
                                        found = true;
                                    }
                                }
                    ...
                    for (const { fieldToAggregate, outputFieldName, renameField } of fieldsToAggregate) {
                        ...
                        if (fieldToAggregate !== '') {
                            ...
                            for (let i = 0; i < length; i++) {
                                if (!disableDotNotation) {
                                    let value = (0, lodash_get_1.default)(items[i].json, fieldToAggregate);
                                    if (!keepMissing) {
                    ...
                    for (const key of Object.keys(values)) {
                        if (!disableDotNotation) {
                            (0, lodash_set_1.default)(newItem.json, key, values[key]);
                        }
                        else {
                    ...
                    if (fieldsToExclude.length || fieldsToInclude.length) {
                        newItems = newItems.reduce((acc, item) => {
                            ...
                            if ((0, lodash_isempty_1.default)(newItem)) {
                                return acc;
                            }
                ...
                newItems.sort((a, b) => {
                    ...
                    for (const key of keys) {
                        let equal;
                        if (!disableDotNotation) {
                            equal = (0, lodash_isequal_1.default)((0, lodash_get_1.default)(a.json, key), (0, lodash_get_1.default)(b.json, key));
                        }
                        else {
                            equal = (0, lodash_isequal_1.default)(a.json[key], b.json[key]);
                        }
                        if (!equal) {
                            let lessThan;
                            if (!disableDotNotation) {
                                lessThan = (0, lodash_lt_1.default)((0, lodash_get_1.default)(a.json, key), (0, lodash_get_1.default)(b.json, key));
                            }
                            else {
                                lessThan = (0, lodash_lt_1.default)(a.json[key], b.json[key]);
                            }
                            result = lessThan ? -1 : 1;
                            break;
                        }
                ...
                for (const key of keys) {
                    ...
                    for (const item of newItems) {
                        ...
                        const value = !disableDotNotation ? (0, lodash_get_1.default)(item.json, key) : item.json[key];
                ...
                if (removeOtherFields) {
                    data = data.map((item, index) => ({
                        json: (0, lodash_pick_1.default)(item.json, ...keys),
                        pairedItem: { item: index },
                    }));
                }
                ...
                if (type === 'simple') {
                    ...
                    for (const { fieldName } of sortFields) {
                        ...
                        for (const item of items) {
                            if (!disableDotNotation) {
                                if ((0, lodash_get_1.default)(item.json, fieldName) !== undefined) {
                                    found = true;
                                }
                            }
                    ...
                    newItems.sort((a, b) => {
                        ...
                        for (const field of sortFieldsWithDirection) {
                            let equal;
                            if (!disableDotNotation) {
                                const _a = typeof (0, lodash_get_1.default)(a.json, field.name) === 'string'
                                    ? (0, lodash_get_1.default)(a.json, field.name).toLowerCase()
                                    : (0, lodash_get_1.default)(a.json, field.name);
                                const _b = typeof (0, lodash_get_1.default)(b.json, field.name) === 'string'
                                    ? (0, lodash_get_1.default)(b.json, field.name).toLowerCase()
                                    : (0, lodash_get_1.default)(b.json, field.name);
                                equal = (0, lodash_isequal_1.default)(_a, _b);
                            }
                            else {
                            ...
                            if (!equal) {
                                ...
                                if (!disableDotNotation) {
                                    ...
                                    const _b = typeof (0, lodash_get_1.default)(b.json, field.name) === 'string'
                                        ? (0, lodash_get_1.default)(b.json, field.name).toLowerCase()
                                        : (0, lodash_get_1.default)(b.json, field.name);
                                    lessThan = (0, lodash_lt_1.default)(_a, _b);
                                }
                                else {
                                    const _a = typeof a.json[field.name] === 'string'
                                        ? a.json[field.name].toLowerCase()
